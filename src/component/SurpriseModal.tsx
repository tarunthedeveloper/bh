        ...
        <div className={`handwritten-letter ${showLetter ? "show" : ""}`}>
          <div className="letter-paper">
            <div className="letter-header">
              <h2 className="handwritten-title">My Dearest Bhoomi</h2>
            </div>
            <div className="handwritten-content">
              <p className="handwritten-line">
                Every moment with you is pure euphoria for me...
              </p>
              <p className="handwritten-line">
                You are the pearl of my oyster,
              </p>
              <p className="handwritten-line">
                the laughter that brings peace to my heart,
              </p>
              <p className="handwritten-line">
              ...
              <div className="handwritten-signature">
                Forever yours,
                <br />
                <span className="signature-name">Your Tarun</span>
              </div>
            </div>
          </div>
        </div>
